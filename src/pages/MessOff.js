...
function MessOff() {
  let requestMessOff = async (event) => {
    ...
    let response = await fetch("http://localhost:4000/pages/requestMessOff", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    if (user) {
      fetch("http://localhost:4000/pages/countMessOff", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    ...
    <div className="w-full h-screen gap-10 flex flex-col items-center  max-h-screen overflow-y-auto pt-[500px] sm:pt-[6rem] md:pt-[6rem] lg:pt-[3rem]">
      <h1 className="text-white font-bold text-5xl">Mess Off</h1>
      <ul className="flex gap-5 text-white text-2xl px-[3rem] sm:p-0 text-center">
      ...
      <div className="w-full gap-10 flex items-center justify-center flex-wrap">
        <div className="h-[33vh] gap-9 flex items-center justify-center flex-wrap">
          <Doughnut
            datasetIdKey="id"
            data={{
              labels,
        ...
        <div className="w-full sm:w-96 max-w-md max-h-60 p-4 border rounded-lg shadow sm:p-8 bg-neutral-950 border-neutral-900 drop-shadow-xl overflow-y-auto">
                ...
                : requestsList.map((req) => (
                    <li className="py-3 sm:py-4" key={req._id}>
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex flex-col items-center  font-semibold text-white text-xl">
